...
--    (gen_random_uuid(), 
--    (SELECT property_id FROM AirBNB_Schema.properties WHERE name = 'Mountain Cabin'),
--    (SELECT user_id FROM AirBNB_Schema.users WHERE email = 'clara@example.com'),
--    '2025-11-21', '2025-11-24', 125.00, 'confirmed');
